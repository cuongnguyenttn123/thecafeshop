...
<div class="row">
	<div class="col-md-7 d-flex align-items-stretch">
		<div class="row flex-grow">
			<div class="col-12 grid-margin">
				<div class="card">
					<div class="card-body">
						<h4 class="card-title">Hóa đơn nhập nguyên liệu</h4>
						<p id="result-form" class="card-description"></p>
						<form id="import_material_form" class="forms-sample">
	...
	<div class="col-md-5 grid-margin stretch-card">
		...
		<div class="card">
			<div class="card-body">
				<h4 class="card-title">Danh sách hóa đơn nhập nguyên liệu</h4>
